...
\hypersetup{
    ...
    urlcolor=links,
    citecolor=links,
    pdftitle={The Tao of Ansible},
    pdfauthor={Ioannis Stylianakos ( a.k.a. John Stilia)},
    pdfsubject={Ansible Configuration Management},
    pdfkeywords={Ansible, DevOps, Automation, Configuration Management},
    pdfproducer={Ioannis Stylianakos ( a.k.a. John Stilia)},
    pdfcreator={Ioannis Stylianakos ( a.k.a. John Stilia)}
}
